...
public class DriverControladorDatosRelaciones {
    private static void menu() {
        ...
        System.out.println("\t       input: 4 <integer idtarea1> <integer idtarea2> <double similitud> <integer tipo> \"<String>\" ");
        System.out.println("\t 5) anadirRelaciones(String[][] Relacion)");
        System.out.println("\t       input: 5 <int: N> N veces: {<integer idtarea1> <integer idtarea2> <double similitud> <integer tipo> \"<String>\"}");
        System.out.println("\t 6) modificarArchivo(String[][] Relacion)");
        System.out.println("\t       input: 6 <int: N> N veces: {<integer idtarea1> <integer idtarea2> <double similitud> <integer tipo> \"<String>\"}");
        System.out.println("\t 7) leerRelaciones()");
        System.out.println("\t       input: 7");
        System.out.println("\t 8) modificarRelacion(String id, String[] str)");
        System.out.println("\t       input: 8 <integer idtarea1> <integer idtarea2> <double similitud> <integer tipo> \"<String>\" ");
