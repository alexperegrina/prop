...
public class ControladorTareas {
    ...
    //private HashMap<Integer,Tarea>  CjTareas = new HashMap<Integer,Tarea>();
    ...
    //private HashMap<Integer,Relacion>  CjRelaciones = new HashMap<Integer,Relacion>();
    private HashMap<Integer,Relacion>  CjRelaciones;
    private Integer contIdRel;
    
    //private HashMap<Integer,ArrayList<Integer>>  tareaRelacionCoste = new HashMap<Integer,ArrayList<Integer>>();
    //private HashMap<Integer,ArrayList<Integer>>  tareaRelacionTiempo = new HashMap<Integer,ArrayList<Integer>>();
