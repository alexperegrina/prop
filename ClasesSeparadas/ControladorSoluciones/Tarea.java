...
public class Tarea {
    ...
    public Tarea(int id, String nombre, double tiempoProduccion, double tiempoPreparacion, double costeProduccion, double costePreparacion, String descripcion) {
        if(tiempoProduccion<=0.) throw new IllegalArgumentException("Error: tiempoProduccion > 0.");
        if(tiempoPreparacion<=0.) throw new IllegalArgumentException("Error: tiempoPreparacion > 0.");
        if(costeProduccion<=0.) throw new IllegalArgumentException("Error: costeProduccion > 0.");
        if(costePreparacion<=0.) throw new IllegalArgumentException("Error: costePreparacion > 0.");
