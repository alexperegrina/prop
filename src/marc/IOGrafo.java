...
public class IOGrafo {
    ...
    public void leerGrafo(Grafo<Integer, Double> G, String path) {
        File archivo = null;
        FileReader fr = null;
    ...
    public void imprimirCiclo(ArrayList<Arista> retC ) {
        System.out.print("IMPRESIÓN DE Ciclo Euleriano:");
        for (int i = 0; i < retC.size(); ++i)
        {
            System.out.print(retC.get(i).origen() + "," + retC.get(i).destino() +".");
        }
    }
}
